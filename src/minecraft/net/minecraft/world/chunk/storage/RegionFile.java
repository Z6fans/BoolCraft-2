...
public class RegionFile
{
     ...
     */
    private synchronized void write(int p_76706_1_, int p_76706_2_, byte[] p_76706_3_, int p_76706_4_)
    {
        try
        {
            ...
            this.setChunkTimestamp(p_76706_1_, p_76706_2_, (int)(System.currentTimeMillis() / 1000L));
        }
